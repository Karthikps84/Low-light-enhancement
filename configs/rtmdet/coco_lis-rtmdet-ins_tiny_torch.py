...
data_root = ''
classes = ("bicycle", "car", "motorcycle", "bus", "bottle", "chair", "dining table", "tv")
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='merged_train_lis_coco.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='merged_val_lis_coco.json',
        metainfo=dict(classes=classes),
        data_prefix=dict(img=''),
        ))
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root +'merged_val_lis_coco.json',
    metric=['bbox', 'segm'],
    format_only=False,
